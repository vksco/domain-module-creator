...
namespace Vksco\DomainModuleCreator\Datasystem;
...
class Datasystem
{
    ...
    {
        return array_key_exists('no-timestamps', $this->data) && $this->data['no-timestamps'] ? false : true;
    }
    ...
    {
        return array_key_exists('softdeletes', $this->data) && $this->data['softdeletes'];
    }
